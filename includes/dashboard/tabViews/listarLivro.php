            ...
            <div class="dash">
                ...
                <div class="seusLivros">
                    ...
                    $sql = "SELECT 
                                                    ...
                                                    GROUP_CONCAT(img.caminho_imagem) AS capa,
                                                    u.nome_usuario,
                                                    u.email_usuario
                                                FROM tb_livro l
                                                ...
                                                LEFT JOIN tb_livro_imagem img ON l.id_livro = img.id_livro  -- Ajuste importante
                    ...
                    while ($livros = mysqli_fetch_assoc($result)) {
                        ...
                        $capas = explode(',', $livros['capa']); // transforma em array
                        $primeira_capa = $capas[0];             // pega a primeira
                        echo "<img src='/SistemaBookare/includes/dashboard/tabViews/{$primeira_capa}' alt='Capa do livro'>";
                        echo "</div>";
                    ...
                    <article class="detailsBook">
                        ...
                        <div class="estadoLivros">
                            <div class="conservFotos">
                                <img id="img1" src="" alt="Foto da Capa do Livro">
                            </div>
                            <div class="conservFotos">
                                <img id="img2" src="" alt="Foto da Capa do Livro">
                            </div>
                            <div class="conservFotos">
                                <img id="img3" src="" alt="Foto da Capa do Livro">
                            </div>
                            <div class="conservFotos">
                                <img id="img4" src="" alt="Foto da Capa do Livro">
                            </div>
                            <div class="conservFotos">
                                <img id="img5" src="" alt="Foto da Capa do Livro">
                            </div>
                            <div class="conservFotos">
                                <img id="img6" src="" alt="Foto da Capa do Livro">
                            </div>
                        </div>
