    ...
    <div class="container-cadastro-livro">
        ...
        <div class="lado-direito">
            ...
            <div class="infos-isbn">
                ...
                <ul class="small-list">
                    <li>Insira o código do livro (ISBN) para que os dados e a capa sejam preenchidos automaticamente.</li>
                    <li>Se o livro não tiver código, você pode preencher os dados manualmente.</li>
                </ul>
            </div>
